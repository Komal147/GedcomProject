        ...
        if self.alive:
            for marriage in self.marriage_info:
                if (not marriage['divorce_date']) and (not marriage['spouse_death_date']):
                    return "ERROR: INDIVIDUAL: US30: " + self.identifier + ": " + self.name + " alive and married."
...
if __name__ == '__main__':
    ...
    for individual in sorted_individuals.values():
        ...
        for desc in individual.descendants:
            print('Descendant of ' + individual.name + ' ' + desc.name)
