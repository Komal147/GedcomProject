...
class TestMarriedToDescendants(unittest.TestCase):
    ...
    def test_married_to_descendants_descendant_married(self):
        ...
        self.assertEqual(self.individual.married_to_descendants(self.families), "ERROR: INDIVIDUAL: US17: @I1@: John Doe is married to descendant Jane Doe in family @F1@")
    ...
    def setUp(self):
        self.individuals = [
            gedcom_data.Individual("@I1@", "John Doe", "M", "1990-01-01", alive=True, marriage_info=[
                {"family_id": "@F1@", "marriage_date": "2010-05-20", "divorce_date": None, "spouse_id": "@I2@", "spouse_death_date": None}
            ]),
            gedcom_data.Individual("@I2@", "Jane Doe", "F", "1992-03-15", alive=False, marriage_info=[
                {"family_id": "@F2@", "marriage_date": "2015-12-10", "divorce_date": None, "spouse_id": "@I3@", "spouse_death_date": None}
            ]),
            gedcom_data.Individual("@I3@", "Alice Smith", "F", "1985-07-20", alive=True, marriage_info=[
                {"family_id": "@F2@", "marriage_date": "2015-12-10", "divorce_date": "2018-12-10", "spouse_id": "@I1@", "spouse_death_date": None}
            ]),
            gedcom_data.Individual("@I4@", "Bob Johnson", "M", "1978-11-10", alive=False, marriage_info=[
                {"family_id": "@F2@", "marriage_date": "2015-12-10", "divorce_date": None, "spouse_id": "@I1@", "spouse_death_date": "2018-12-10"}]),
            gedcom_data.Individual("@I4@", "Bob Johnson", "M", "1978-11-10", alive=False, marriage_info=[])
        ]

    def test_alive_and_married_alive_married(self):
        result = self.individuals[0].alive_and_married()
        self.assertEqual(result, "ERROR: INDIVIDUAL: US30: @I1@: John Doe alive and married.")
